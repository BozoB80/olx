...
import { ArrowLeftIcon, ChatBubbleLeftRightIcon, EllipsisVerticalIcon } from '@heroicons/react/24/solid';
      ...
      <div className='absolute top-0 w-full z-50 bg-white sm:hidden'>
        <div className='relative'>
          ...
          <div className='bg-[#f1f4f5] p-2 w-full'>
            ...
            <button className='flex w-full py-2 gap-3 justify-center items-center border border-black rounded-[4px]'>
