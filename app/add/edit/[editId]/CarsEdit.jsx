...
import ChildrenList from "@/app/publish/[category]/ChildrenList";

const CarsEdit = ({ id, details }) => {
  const [cars] = useCollectionData(
  ...
  const [product, setProduct] = useState({
    ...
    fuel: details.fuel,
    cubic: details.cubic,
    kilowatts: Number(details.kilowatts),
    drive: details.drive,
      ...
      <div className="w-full sm:w-[800px] h-full bg-white rounded-md px-1 sm:px-3 py-6">
        ...
        >
          <div className="w-full">
            ...
            <label htmlFor="make" className="uppercase text-xs font-semibold">
              Manufacturer
            </label>
            <select
              id="make"
            ...
            <label htmlFor="model" className="uppercase text-sm font-semibold">
              Model
            </label>
            <select
              id="model"
            ...
            >
              ...
              {models?.docs.map((doc) => (
                <ChildrenList
                  key={doc.id}
                  path={`categories/PE2j37QZeo1UwY4TKZPJ/manufacturer/${doc.id}/model`}
                />
              ))}
            </select>

            <div className="w-full my-4">
              <h1 className="uppercase text-sm sm:text-base font-semibold">
                LOCATION
              </h1>
