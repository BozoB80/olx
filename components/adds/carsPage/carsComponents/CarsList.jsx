...
const CarsList = ({ adds }) => {
  ...
  return (
    <div className='flex flex-col bg-[#f1f4f5]'>
      <div className='flex w-full justify-center items-center pt-2 sm:p-4'>
        <div className='flex gap-3 bg-white px-6 py-2 rounded-l-md shadow-xl border-r'>
        ...
        <div className="flex bg-white px-5 py-2 shadow-xl border-r">
        ...
        <div>
          <button className='flex items-center bg-white px-6 py-2 gap-3 rounded-r-md shadow-xl'>
